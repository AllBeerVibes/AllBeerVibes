...
var styleExplanationArray = ["IPAs (short for India Pale Ales) boast strong hop bitterness with piney and floral flavors. These beers have high alcohol content.", "Stouts are dark beers that are similar to porters, but with stronger roasted flavors. This style features mid to high alcohol levels.", "Witbier, white beer, bière blanche, or simply witte is a barley/wheat, top-fermented beer brewed mainly in Belgium and the Netherlands. It gets its name due to suspended yeast and wheat proteins which cause the beer to look hazy, or white, when cold.", "Sour Ale is the oldest type of beer in history. Sours today are tart-tasting, and made with wild bacteria and yeasts, whereas more familiar beers are made in sterile environments with specific yeast strains.", "Lagers are the crisp, thirst-quenching yellow beers like Budweiser and the like. Lagers are made with bottom-fermenting yeasts that need the liquid they’re fermenting to be cold and still for a longish time.", "Lively and fruity, sometimes sweet or bittersweet. Barleywine is anything from an amber to a dark brown color, with aromas ranging from rich fruits to bold hops."];
var answerStyle = '';
